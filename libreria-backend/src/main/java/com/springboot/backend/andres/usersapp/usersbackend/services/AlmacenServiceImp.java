    ...
    for (TraspasoRequest traspaso : traspasos) {
        ...
        try {
            ...
            DetalleAlmacen detalleOrigen = detalleAlmacenRepository
                    ...
                    .orElseThrow(() -> new RuntimeException("El medicamento con ID " + medicamentoId + " no existe en el almacén origen."));
            ...
            if (cantidadATraspasar <= 0) {
                throw new RuntimeException("No hay stock disponible del medicamento con ID " + medicamentoId + " en el almacén origen.");
            }
            ...
            mensajes.add("Error con el traspaso del medicamento ID " + medicamentoId + ": " + e.getMessage());
        }
    }
    ...
    for (TraspasoRequest traspaso : traspasos) {
        ...
        try {
            ...
            DetalleAlmacen detalleAlmacen1 = detalleAlmacenRepository
                    .findById(new DetalleAlmacenId(1L, medicamentoId))
                    .orElseThrow(() -> new RuntimeException(
                            "El medicamento con ID " + medicamentoId + " no existe en el almacén 1."));
            ...
            mensajes.add("Se ajustaron " + cantidadATraspasar + " unidades del medicamento "
                    + medicamento.getNombre() + " (ID: " + medicamentoId + ") .");
    ...
    for (TraspasoRequest ajuste : ajustes) {
        ...
        try {
            DetalleAlmacen detalle = detalleAlmacenRepository
                    ...
                    .orElseThrow(() -> new RuntimeException("El medicamento no existe en el almacén."));
            ...
            String mensaje = String.format("%s de %d unidades del medicamento ID %d. Motivo: %s",
